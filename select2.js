        ...
        updateResults: function (initial, tokenizeOnEnter) {
            ...
            opts.query({
                ...
                if (data.results.length === 0 && checkFormatter(opts.formatNoMatches, "formatNoMatches")) {
                    render($('<li class="select2-no-results">').append(evaluate(opts.formatNoMatches, opts.element, search.val())));
                    return;
                }
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        initContainer: function () {
            ...
            this.search.on("blur", this.bind(function(e) {
                ...
                if (document.activeElement === this.body.get(0) && !this.body.hasClass('modal-open')) {
